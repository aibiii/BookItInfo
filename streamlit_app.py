...
def policy_page():
    ...
    st.write("This policy is effective as of 2023-07-28")

    st.subheader("Contact Us")
    st.write(
        "If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us at aibibi.kuan1@gmail.com."
    )
...
with st.sidebar:
    selected_page = st.selectbox("Select page", ("main", "privacy policy", "support"))

if selected_page == "main":
    main_page()
if selected_page == "privacy policy":
    policy_page()
if selected_page == "support":
    support_page()
